// Chiudere un channel serve ad indicare che non ci saranno
// più valori che verranno inviati su quel canale.
// Questo è utile per comunicare il completamento di
// un operazione a chi sta ascoltando sul canale.
...
func main() {
    ...
    // di [sincronizzazione](channel-synchronization) che abbiamo
