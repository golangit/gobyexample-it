...
# essere particolarmente vantaggioso. Svariate altre
# funzionalità di Go sono basate su channel e `select`,
# vedremo due esempi di questo a breve: i _timer_ e i _ticker_.
